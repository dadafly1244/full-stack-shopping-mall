...
const NewProductCard = ({ product }: { product: ProductType }) => {
  ...
  return (
    <Link
      className="hover:cursor-pointer hover:bg-white group overflow-hidden"
      to={`/product/detail/${product.id}`}
    >
      <div className="flex justify-center h-64 items-start w-64 relative self-stretch object-contain ">
        <ProductImage
          key="headerImage"
