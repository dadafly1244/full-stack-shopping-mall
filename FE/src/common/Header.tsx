...
const Header = () => {
  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      {isShowAdminButton && (
        <Button type="submit" size="sm" className="w-80 h-10 bg-blue-gray-600">
  ...
  return (
    <Navbar className="sticky top-0 z-10 h-max max-w-full rounded-none px-4 py-2 lg:px-8 lg:py-4 shadow-none bg-blue-gray-50">
      <ul className="hidden mt-2 mb-4 lg:flex flex-row gap-2 lg:mb-0 lg:mt-0 justify-center lg:items-center lg:gap-6 ">
        ...
        <Button
          ...
          size="sm"
          className={cn(
            !isShowAdminButton && "hidden",
            "w-18 h-10 bg-blue-gray-600 whitespace-break-spaces"
          )}
        >
          <NavLink to="/admin">관리자 페이지</NavLink>
        </Button>
